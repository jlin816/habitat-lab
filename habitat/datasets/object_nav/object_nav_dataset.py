...
from habitat_lab.habitat.core.simulator import AgentState, ShortestPathPoint
from habitat_lab.habitat.core.utils import DatasetFloatJSONEncoder
from habitat_lab.habitat.datasets.pointnav.pointnav_dataset import (
    CONTENT_SCENES_PATH_FIELD,
    DEFAULT_SCENE_PATH_PREFIX,
    PointNavDatasetV1,
)
from habitat_lab.habitat.tasks.nav.object_nav_task import (
    ObjectGoal,
