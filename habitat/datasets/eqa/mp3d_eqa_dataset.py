...
from habitat_lab.habitat.core.simulator import AgentState
from habitat_lab.habitat.datasets.utils import VocabDict
from habitat_lab.habitat.tasks.eqa.eqa import EQAEpisode, QuestionData
from habitat_lab.habitat.tasks.nav.nav import ShortestPathPoint
from habitat_lab.habitat.tasks.nav.object_nav_task import ObjectGoal
