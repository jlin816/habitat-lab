...
# -----------------------------------------------------------------------------
# # VLN TASK DESCRIPTION SENSOR
# -----------------------------------------------------------------------------
_C.TASK.DESCRIPTION_SENSOR = CN()
_C.TASK.DESCRIPTION_SENSOR.TYPE = "DescriptionSensor"
_C.TASK.DESCRIPTION_SENSOR_UUID = "descriptions"
# -----------------------------------------------------------------------------
...
_C.DATASET.DATA_PATH = (
    "../../../VLN_CE/data/datasets/pointnav/habitat-test-scenes/v1/{split}/{split}.json.gz"
)
