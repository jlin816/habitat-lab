...
from habitat_lab.habitat import Dataset
from habitat_lab.habitat.core.utils import tile_images
from habitat_lab.habitat.utils import profiling_wrapper
from habitat_lab.habitat.utils.pickle5_multiprocessing import ConnectionWrapper
        ...
        try:
            ...
            while command != CLOSE_COMMAND:
                if command == STEP_COMMAND:
                    ...
                    if isinstance(env, (habitat_lab.habitat.RLEnv, gym.Env)):
                        # habitat.RLEnv
