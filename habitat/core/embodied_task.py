...
from habitat_lab.habitat.core.simulator import Observations, SensorSuite, Simulator
from habitat_lab.habitat.core.spaces import ActionSpace, EmptySpace, Space
