...
from habitat_lab.habitat.core.simulator import ActionSpaceConfiguration, Sensor, Simulator
from habitat_lab.habitat.core.utils import Singleton
...
class Registry(metaclass=Singleton):
    ...
    def register_task(cls, to_register=None, *, name: Optional[str] = None):
        ...
        .. code:: py
            ...
            from habitat_lab.habitat.core.registry import registry
            from habitat_lab.habitat.core.embodied_task import EmbodiedTask
