...
from habitat_lab.habitat.core.simulator import Observations, Sensor
...
@registry.register_sensor(name="DescriptionSensor")
class DescriptionSensor(Sensor):
    def __init__(self, **kwargs):
        self.uuid = "descriptions"
        self.observation_space = spaces.Discrete(0)
