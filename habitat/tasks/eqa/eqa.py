...
from habitat_lab.habitat.core.embodied_task import Action, Measure
from habitat_lab.habitat.core.registry import registry
from habitat_lab.habitat.core.simulator import Observations, Sensor, SensorTypes
from habitat_lab.habitat.core.spaces import ListSpace
from habitat_lab.habitat.core.utils import not_none_validator
from habitat_lab.habitat.tasks.nav.nav import NavigationEpisode, NavigationTask
...
class AnswerAccuracy(Measure):
    ...
    def update_metric(
        ...
        if episode is None:
            return
        answer_idx = self._dataset.answer_vocab.word2idx(episode.question.answer_text)
