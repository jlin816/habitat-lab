...
r"""BaselineRegistry is extended from habitat_lab.habitat.Registry to provide
...
class BaselineRegistry(Registry):
    ...
    def register_trainer(cls, to_register=None, *, name: Optional[str] = None):
        ...
        """
        from habitat_lab.habitat_baselines.common.base_trainer import BaseTrainer
    ...
    def register_env(cls, to_register=None, *, name: Optional[str] = None):
        ...
        """
        from habitat_lab.habitat import RLEnv
    ...
    def register_policy(cls, to_register=None, *, name: Optional[str] = None):
        ...
        .. code:: py
            ...
            from habitat_lab.habitat_baselines.common.baseline_registry import (
                baseline_registry
            )
